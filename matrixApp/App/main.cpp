    ...
    if (choice == "help") help();
        ...
        if (type == 0) {//int
            if (choice == "addMatrix") {//dodawanie
                ...
                cout <<"Podaj liczby calkowite ktore beda znajdowac sie w macierzy A oraz B: ";
            ...
            if (choice == "addMatrix") {
                ...
                cout <<"Podaj liczby zmiennoprzecinkowe ktore beda znajdowac sie w macierzy A i B: ";
                if (!fill_matrix(matrixA, rows, columns)) {
                    for (int i = 0; i < rows; i++) {
                        delete[] matrixA[i];
                        delete[] matrixB[i];
                ...
                matrixA = create_matrix_double(rows, columns);
                cout <<"Podaj liczby zmiennoprzecinkowe ktore beda znajdowac sie w macierzy A: ";
                if (!fill_matrix(matrixA, rows, columns)) {
                    for (int i = 0; i < rows; i++) {
                        delete[] matrixA[i];
                    }
